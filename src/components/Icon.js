...
const Icon = ({muted}) => {
    ...
    return ( 
        <div className="icon">
           ...
           {window.innerWidth > 720 && <video id="video" className="background"  autoPlay loop muted={muted}> <source src={process.env.PUBLIC_URL + (icons[id]["video"])} type="video/mp4" /> </video> }
           <div id="cover"></div>
